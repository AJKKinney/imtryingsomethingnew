...
| Constant | Value | Provenance |
|---|---|---|
| `AMPLIFIERS` | { gain: { id: `gain`, draw: 1, selfHeat: `0.5 + 0.5 x adjacent emitters`, effect: `+40 -> 60% damage to orthogonally adjacent emitters`, gates: _(3 entries)_ }, clock: { id: `clock`, draw: 1, selfHeat: `+1 flat`, effect: `+60 -> 80% rate; raises the emitter own heat and drives the region toward overclock`, gates: _(2 entries)_ }, focus: { id: `focus`, draw: 1, selfHeat: `+1 flat`, effect: `+50 -> 70% area, AoE emitters only`, gates: _(2 entries)_ }, governor: { id: `governor`, draw: 1, selfHeat: `0.5 + 0.5 x adjacent emitters`, effect: `+140 -> 210% damage, minus 40 -> 55 points per additional emitter sharing that region, floored at zero`, gates: _(3 entries)_ } } | authored · draft · axes damage+heat · surrogate · §59.3, §122.5 |
